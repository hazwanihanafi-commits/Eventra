  ...
  return (
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        <h2 style={{ marginTop: 30 }}>Organiser Login</h2>
        <p style={{ color: "#666", fontSize: 14 }}>Access your event workspace.</p>
        ...
        {APP_CONFIG.authMode === "legacy" && (
          <p style={{ marginTop: 18, fontSize: 12, color: "#888" }}>
            Legacy mode is enabled. Set VITE_AUTH_MODE=event before commercial deployment.
          </p>
        )}
      </div>
    </div>
